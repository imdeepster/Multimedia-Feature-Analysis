...
for nf=1:numfiles
	...
	for i=1:numFrames
		...
		ca = mat2cell(grayImage, rowvector, colvector); %divide the frame into its component blocks, part of this code has been reused and mentioned on the project report
		Blocknumber = 1; 
